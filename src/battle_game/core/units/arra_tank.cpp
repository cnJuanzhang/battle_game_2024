...
arra_Tank::arra_Tank(GameCore *game_core, uint32_t id, uint32_t player_id)
      ...
      tank_body_model_index = mgr->RegisterModel(
          {
              ...
              {{0.3f, 0.5f}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}},
              {{-0.3f, -1.0f}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}},
              {{0.3f, -1.0f}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}},
              {{0.9f, 0.5f}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}},
              {{-0.9f, 0.5f}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}},
              {{0.0f, 1.5f}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}},
          },
          {0, 2, 3, 0, 1, 3, 4, 5, 6});
      // tank_body_model_index = mgr->RegisterModel(
      //     {
...
void arra_Tank::Update() {
  TankMove(3.0f, glm::radians(180.0f));
  TurretRotate();
  Fire();
}

void arra_Tank::TankMove(float move_speed, float rotate_angular_speed) {
...
bool arra_Tank::IsHit(glm::vec2 position) const {
...
const char *arra_Tank::UnitName() const {
  return "arra Tank";
}

const char *arra_Tank::Author() const {
  return "arra";
}
}  // namespace battle_game::unit
